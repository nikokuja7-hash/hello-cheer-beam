...
import { Zap, Trophy, Clock, ChevronRight, Bell, Flame } from "lucide-react";
        ...
        <div className="relative">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div>
              ...
              <p className="font-display text-lg tracking-wider">KES {t.entry_fee_kes}</p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground">Spots</p>
              <p className="font-display text-lg tracking-wider">{spotsLeft}/{t.max_players}</p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground">Closes</p>
              <p className="font-display text-lg tracking-wider">
                {closes ? closes.toLocaleDateString("en-KE", { weekday: "short" }) : "—"}
              </p>
            </div>
          </div>
